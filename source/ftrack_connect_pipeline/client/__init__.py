...
class BasePipelineClient(object):
    ...
    def __init__(self, session, ui):
        ...
        self.logger.info('initalising client')
    ...
    def ready(self, callback_function):
        self.discover_hosts(callback_function)

    def connect(self, host_id, callback):
        self._callback = callback
        self._hostid = host_id['hostid']
    ...
    def _host_discovered(self, callback, event):
    ...
    def discover_hosts(self, callback):
        ...
        mycallback = functools.partial(self._host_discovered, callback)
