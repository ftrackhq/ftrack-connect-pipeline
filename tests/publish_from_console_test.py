...
#This is not beign set because the host already emmited the event
#host_class.context_id = '15b346c0-022e-11ea-bc02-ae185fc6f561'
...
for publisher_candidate in client_connection.host_connection.definitions['publisher']:
    if (
        ...
        and publisher_candidate['host_type'] == 'python'
    ):
